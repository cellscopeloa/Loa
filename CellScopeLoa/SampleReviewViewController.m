...
@interface SampleReviewViewController ()

@end

@implementation SampleReviewViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if([segue.identifier isEqualToString:@"ReviewCount"]) {
        CountViewController* viewController = segue.destinationViewController;
        viewController.sample = sample;
    }
    else if([segue.identifier isEqualToString:@"ReviewVideos"]) {
